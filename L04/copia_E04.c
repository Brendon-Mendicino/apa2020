...
bool selezionaDati( Tratta *tratta, int n_tratte, comando_e cmd);


void f_date( Tratta *tratta, int n_tratte);
void f_partenza( Tratta *tratta, int n_tratte);
void f_capolinea( Tratta *tratta, int n_tratte);
void f_ritardo( Tratta *tratta, int n_tratte);
void f_ritardo_tot( Tratta *tratta, int n_tratte);
...
int main(void)
{
	...
	while(loop) {
		...
		selezionaDati( tratta, n_tratte, cmd); 
	}
...
{
	switch (cmd) {
		case r_date: f_date( tratta, n_tratte); break;
		case r_partenza: f_partenza( tratta, n_tratte); break;
		case r_capolinea: f_capolinea( tratta, n_tratte); break;
		case r_ritardo: f_ritardo( tratta, n_tratte); break;
		case r_ritardo_tot: f_ritardo_tot( tratta, n_tratte); break;
